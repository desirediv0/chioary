            ...
            <motion.div className="w-full md:w-1/2 p-6 md:p-8 bg-black relative" variants={containerVariants}>
                <div className="space-y-6 md:space-y-8">
                    ...
                    <motion.div variants={itemVariants}>
                        ...
                        <motion.div className="grid grid-cols-2 gap-2 md:gap-3" variants={itemVariants}>
                            <motion.div variants={amountButtonVariants} custom={0} whileHover="hover" whileTap="tap">
                                <Button
                                    variant="outline"
                                    className={cn(
                                        "rounded-full border-2 py-4 md:py-6 text-base md:text-lg font-medium w-full flex items-center justify-center hover:bg-transparent hover:text-white",
