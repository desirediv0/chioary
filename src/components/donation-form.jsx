    ...
    return (
      ...
      >
        ...
        <div className=" w-full lg:p-3 flex flex-col md:flex-row">
          ...
          <motion.div
            className="w-full md:w-1/2 p-6 md:p-8 bg-[var(--custom-color-2)] relative"
            variants={containerVariants}
          >
            <div className="space-y-6 md:space-y-8">
              ...
              <motion.div variants={itemVariants}>
                ...
                <motion.div
                  className="relative mb-4 w-[120px] md:w-[150px]"
              ...
              {/* Submit button */}
              <motion.div
                className="flex justify-start pt-2 md:p-6"
                variants={itemVariants}
              >
                <motion.div
                  variants={buttonVariants}
                ...
                >
                  ...
                  >
                    <span className="px-4 md:px-6 py-2 md:py-3 font-semibold text-white text-base md:text-lg">
                      Donate Now
                    </span>
