      ...
      <div className="container mx-auto px-4 py-16 bg-gradient-to-b from-white to-amber-50">
        ...
        >
          ...
          <p className="mt-4 text-xl text-center text-gray-600 max-w-2xl">
            Join us for our upcoming events and experience unforgettable moments
            together.
          </p>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {isClient && (
                            <div
                              className={`absolute top-4 right-4 z-10 px-3 py-1 rounded-full text-xs uppercase font-bold shadow-md ${upcoming
                          ...
                          <div className="flex flex-col md:flex-row h-full">
                            <div className="w-full md:w-2/5 relative h-56 md:h-auto">
                              {event.thumbnail ? (
                                ...
                                <div
                                  className={`w-full h-full flex items-center justify-center ${upcoming
